...
def main(event, context):
    ...
    # Defina o status a ser atribuído aos hosts (0-Habilita, 1-Desabilita)
    STATUS = '0'
    ...
    for listas in result:
        for hosts in listas:
            ...
            # Atualiza o status do host no Zabbix com base na variável STATUS
            zapi.host.update({
                "hostid": int(hostid),
                "status": STATUS,  # Use o valor da variável STATUS
                "description": mensagemstatus
            })
